  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new CharactersMedia" do
        ...
        }.to change(CharactersMedia, :count).by(1)
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved characters_media as @characters_media" do
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested characters_media" do
        characters_media = CharactersMedia.create! valid_attributes
        put :update, {:id => characters_media.to_param, :characters_media => new_attributes}, valid_session
      ...
      it "assigns the requested characters_media as @characters_media" do
        characters_media = CharactersMedia.create! valid_attributes
        put :update, {:id => characters_media.to_param, :characters_media => valid_attributes}, valid_session
        expect(assigns(:characters_media)).to eq(characters_media)
      end
    ...
    describe "with invalid params" do
      it "assigns the characters_media as @characters_media" do
        characters_media = CharactersMedia.create! valid_attributes
        put :update, {:id => characters_media.to_param, :characters_media => invalid_attributes}, valid_session
        expect(assigns(:characters_media)).to eq(characters_media)
      end
